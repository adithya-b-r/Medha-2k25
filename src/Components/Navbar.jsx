...
export const Navbar = () => {
  ...
  return (
    <header className="text-white fixed top-0 left-0 right-0 z-20 md:bg-black/10 bg-black/50 backdrop-blur-[0.5px]">
      ...
      <div className={`absolute left-0 right-0 bg-black/50 backdrop-blur-[10px] transition-all duration-300 ease-in-out overflow-hidden z-20 mx-auto sm:hidden block ${isOpen ? 'max-h-screen' : 'max-h-0'}`}>
        <nav className="p-5">
